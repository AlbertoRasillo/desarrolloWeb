...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Universidad/Bundle/AutenticacionBundle/Resources/views'), 'UniversidadAutenticacion');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('559a92c03a6b6')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UniversidadAutenticacionBundle' => 'Universidad\\Bundle\\AutenticacionBundle\\UniversidadAutenticacionBundle',
